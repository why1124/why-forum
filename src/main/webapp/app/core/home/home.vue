    ...
    <div class="home row">
        ...
        <div class="col-md-9">
            ...
            <ul>
                ...
                <li><a href="https://github.com/jhipster/generator-jhipster/issues?state=open" target="_blank" rel="noopener" v-text="$t('home.link.bugtracker')">JHipster bug
                    tracker</a></li>
            ...
            <p>
                <span v-text="$t('home.like')">If you like JHipster, don't forget to give us a star on</span> <a href="https://github.com/jhipster/generator-jhipster"
