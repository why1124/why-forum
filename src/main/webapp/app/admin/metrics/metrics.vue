    ...
    <div>
        <h2>
            ...
            <button class="btn btn-primary float-right" v-on:click="refresh()">
                ...
                <span v-text="$t('metrics[\'refresh.button\']')">Refresh</span>
            </button>
        </h2>
            ...
            <div class="col-md-4">
                ...
                <b-progress variant="success" :max="threadStats.threadDumpAll" striped>
                    <b-progress-bar :value="threadStats.threadDumpWaiting"
                                    :label="formatNumber1(threadStats.threadDumpWaiting * 100 / threadStats.threadDumpAll) + '%'"></b-progress-bar>
                </b-progress>
                ...
                <b-progress variant="success" :max="threadStats.threadDumpAll" striped>
                    <b-progress-bar :value="threadStats.threadDumpBlocked"
                                    :label="formatNumber1(threadStats.threadDumpBlocked * 100 / threadStats.threadDumpAll) + '%'"></b-progress-bar>
                </b-progress>
